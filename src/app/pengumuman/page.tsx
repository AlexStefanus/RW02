      ...
      <section className="bg-[#00a753] text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-3xl md:text-4xl font-bold mb-4">Pengumuman RW 02 Rangkah</h1>
            <p className="text-lg text-white/90 max-w-2xl mx-auto">Dapatkan pengumuman terkini seputar kegiatan, pembangunan, dan perkembangan di RW 02 Rangkah</p>
          </div>
        </div>
      </section>
