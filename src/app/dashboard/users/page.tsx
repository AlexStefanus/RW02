        ...
        return (
          <div className="flex items-center">
            <div className="flex-shrink-0 w-10 h-10">
              <div className="w-10 h-10 bg-[#00a753] rounded-full flex items-center justify-center">
            ...
            <div className="ml-4">
              <div className="text-sm font-medium text-gray-900">
                ...
                {currentUser?.id === user?.id && <span className="ml-2 px-2 py-1 text-xs bg-green-100 text-green-800 rounded-full">Anda</span>}
              </div>
      ...
      render: (roleActions: any, user: any) => {
        ...
        return (
          <select
            ...
            className="text-sm border border-gray-300 rounded px-2 py-1 focus:outline-none focus:ring-2 focus:ring-[#00a753] focus:border-transparent disabled:opacity-50"
          >
