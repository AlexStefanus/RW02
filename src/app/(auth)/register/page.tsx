...
const RegisterPage = () => {
  ...
  return (
    <ProtectedRoute requireAuth={false}>
      <AuthLayout imageSrc="/pahlawan.png" title="Mulai kelola dan kembangkan website RW 02 Rangkah dengan mudah melalui panel admin" subtitle="Panel Admin" mounted={mounted}>
