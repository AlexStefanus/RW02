...
const RegisterPage = () => {
  ...
  return (
    <ProtectedRoute requireAuth={false}>
      <AuthLayout imageSrc="/stasiun_ngebruk.JPG" title="Mulai kelola dan kembangkan website RW 02 Rangkah dengan mudah melalui panel admin" subtitle="Panel Admin" mounted={mounted}>
