...
const AnnouncementCard = ({ announcement, index, mounted }: AnnouncementCardProps) => {
  ...
  return (
    ...
    >
      <h4 className="font-medium text-gray-900 mb-2 md:mb-3 text-sm leading-relaxed group-hover:text-[#00a753] smooth-transition line-clamp-2">{announcement.title}</h4>
