...
const Footer = () => {
  ...
  return (
    <footer className={`bg-[#00a753] text-white pt-6 md:pt-4 smooth-transition ${mounted ? "smooth-reveal" : "animate-on-load"}`}>
      <div className="max-w-7xl mx-auto px-4 mb-6 sm:px-6 lg:px-8">
        <div className={`flex flex-col md:flex-row justify-between items-center md:items-center mb-6 md:mb-4 smooth-transition ${mounted ? "smooth-reveal stagger-1" : "animate-on-load"}`}>
          ...
          <div className="flex flex-row justify-center md:justify-start gap-2 sm:gap-3 w-full md:w-auto">
            <a
              href="https://www.instagram.com/ngebruk.Tambaksari?igsh=ZHI0dWg2MG8yb3Zq"
            ...
            <a href="https://www.youtube.com/@DesaNgebrugTambaksari" className="flex items-center justify-center px-2 py-2  border border-white/30 rounded-lg hover:bg-white/10 smooth-transition text-xs md:text-sm hover-lift">
              <FiYoutube size={18} className="" />
            </a>
            <a href="https://www.tiktok.com/@ngebruk?_t=ZS-8xvrYJG8yW5&_r=1" className="flex items-center justify-center px-2 py-2  border border-white/30 rounded-lg hover:bg-white/10 smooth-transition text-xs md:text-sm hover-lift">
            ...
            <a href="https://x.com/desa_ngebruk" className="flex items-center justify-center px-2 py-2  border border-white/30 rounded-lg hover:bg-white/10 smooth-transition text-xs md:text-sm hover-lift">
              <FiTwitter size={18} className="" />
            </a>
            <a href="https://www.facebook.com/share/1B5qNupjnh/" className="flex items-center justify-center px-2 py-2  border border-white/30 rounded-lg hover:bg-white/10 smooth-transition text-xs md:text-sm hover-lift">
              <FiFacebook size={18} className="" />
            </a>
          </div>
        </div>
        ...
        <div className={`grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-12 mb-6 md:mb-3 smooth-transition ${mounted ? "smooth-reveal stagger-3" : "animate-on-load"}`}>
          <div className="text-center md:text-left">
            <h3 className="text-lg md:text-xl font-bold mb-2 md:mb-1 smooth-transition">RW 02 Rangkah</h3>
            <p className="text-white/90 mb-3 md:mb-2 text-sm md:text-sm smooth-transition">Kecamatan Tambaksari</p>
            <p className="text-white/80 leading-relaxed text-xs md:text-xs break-words smooth-transition">
              Jl. Rangkah VI No.55, Kelurahan Rangkah
              <br />
              Kec. Tambaksari, Surabaya, Jawa Timur 60142
            </p>
          </div>
