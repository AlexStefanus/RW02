          ...
          {imagePreview ? (
            <div>
              ...
              <div className="flex gap-2 mt-3">
                <button
                  ...
                  disabled={loading}
                  className="flex-1 bg-[#00a753] text-white px-4 py-2 rounded-lg hover:bg-[#008c45] transition-colors disabled:opacity-50 flex items-center justify-center gap-2 text-sm font-medium"
                >
                  <FiImage size={16} />
                  Preview
                </button>
                <button
                  ...
                  disabled={loading}
                  className="flex-1 border border-[#00a753] text-[#00a753] px-4 py-2 rounded-lg hover:bg-[#00a753] hover:text-white transition-colors disabled:opacity-50 flex items-center justify-center gap-2 text-sm font-medium"
                >
                  <FiUpload size={16} />
                  Ganti Gambar
                </button>
            ...
            <div
              ...
              className={`border-2 border-dashed rounded-lg p-6 lg:p-8 text-center transition-colors cursor-pointer h-64 lg:h-80 flex flex-col justify-center ${
                dragActive ? "border-[#00a753] bg-[#00a753]/5" : "border-gray-300 hover:border-[#00a753] hover:bg-gray-50"
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center space-x-3">
              <label className="flex items-center">
                <input type="radio" name="isActive" checked={formData.isActive} onChange={() => onChange("isActive", true)} className="h-4 w-4 text-[#00a753] focus:ring-[#00a753] border-gray-300" disabled={loading} />
                <span className="ml-2 text-sm text-gray-700">Aktif</span>
              </label>
              <label className="flex items-center">
                <input type="radio" name="isActive" checked={!formData.isActive} onChange={() => onChange("isActive", false)} className="h-4 w-4 text-[#00a753] focus:ring-[#00a753] border-gray-300" disabled={loading} />
