  ...
  return (
    <div>
      ...
      <select
        ...
        required={required}
        disabled={disabled}
        className={`form-input app-form-input app-select w-full border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#00a753] focus:border-transparent text-black ${
