...
const AuthButton = ({ children, type = "button", disabled = false, variant = "primary", onClick, mounted = true }: AuthButtonProps) => {
  ...
  const variantClasses = `bg-[#00a753] text-white hover:bg-[#008c45] focus:outline-none focus:ring-2 focus:ring-[#00a753] focus:ring-offset-2 transition-colors ${
    disabled ? "disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-[#00a753]" : ""
  }`;
